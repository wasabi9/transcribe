...
import tqdm
from transcription.audio import SAMPLE_RATE, N_FRAMES, HOP_LENGTH, pad_or_trim, log_mel_spectrogram, load_audio
from transcription.alignment import get_trellis, backtrack, merge_repeats, merge_words
from transcription.decoding import DecodingOptions, DecodingResult
from transcription.tokenizer import LANGUAGES, TO_LANGUAGE_CODE, get_tokenizer
from transcription.utils import exact_div, format_timestamp, optional_int, optional_float, str2bool, write_txt, write_vtt, write_srt, write_ass
...
def cli():
    from transcription import available_models
